...
* Blocking on subject
  * **Is this true?** Will we have multiple observations per subject?
...
power <- 
  data.frame(aim = as.integer(),
             design = as.character(),
             effectSize = as.numeric(),
             n = as.integer(),
             notes = as.character()) %>% 
  rbind(data.frame(aim = 1, design = "One-sample t-test", 
                   effectSize = L[["aim1"]][["d"]],
                   n = ceiling(L[["aim1"]][["n"]]), 
                   notes = NA_character_),
        # data.frame(aim = 2, design = "One-sample t-test", 
        #            effectSize = L[["aim2"]][["d"]],
        #            n = ceiling(L[["aim2"]][["n"]]), 
        #            notes = NA_character_),
        data.frame(aim = 3, design = "One-sample t-test", 
                   effectSize = L[["aim3"]][["d"]],
                   n = ceiling(L[["aim3"]][["n"]]), 
                   notes = NA_character_),
        data.frame(aim = 4, design = "Two-sample t-test", 
                   effectSize = L[["aim4"]][["d"]],
